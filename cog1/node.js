...
define(["exports", "shader"], function(exports, shader) {
	...
	function updateModelview() {
		...
		if(!this.localModelviewUpToDate) {
			...
			let shearingX = this.transformation.shear[0];
			let shearingY = this.transformation.shear[1];
			let shearingZ = this.transformation.shear[2];

			// Modify the matrix this.localShear (see mat4.translate for matrix data structure).
			// apply shearingX
			this.localShear[4] = this.localShear[8] = shearingX

			// apply shearingY
			this.localShear[1] = this.localShear[9] = shearingY

			// apply shearingZ
			this.localShear[2] = this.localShear[6] = shearingZ
